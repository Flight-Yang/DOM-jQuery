...
window.jQuery = function (selectorOrArray) {
  var elements; //判断类型是字符串还是数组，当时选择器 .test 这就是个字符串
  ...
  return {
    ...
    find: function find(selector) {
      ...
      for (var i = 0; i < elements.length; i++) {
        //把获取到的元素转换成数组
        var elements2 = Array.from(elements[i].querySelectorAll(selector)); //把转换成的数组拼接到array数组上
      ...
      array.oldApi = this; //简化 这里对应上面那个newAPi两句,这里是新api,比如child
...
},{}]},{},["C:/Users/86178/AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","jQuery.js"], null)
